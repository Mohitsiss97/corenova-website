...
export const categories = [
  ...
  },
  {
    ...
    integrations: ["Barcode scanners", "Zebra & Honeywell handhelds", "Shopify", "Amazon", "Courier APIs", `${brand.productPrefix} ERP`],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["Vendor portals", `${brand.productPrefix} ERP`, "DocuSign", "Email & WhatsApp", "Excel", "Power BI"],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["GPS & telematics devices", "Google Maps", "FASTag", "Fuel cards", "Courier APIs", `${brand.productPrefix} ERP`],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["QR & RFID readers", `${brand.productPrefix} ERP`, "Google Maps", "WhatsApp", "Email", "Power BI"],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["Payment terminals", "Cash drawers & printers", "Shopify", "Swiggy & Zomato", "Loyalty wallets", `${brand.productPrefix} Stock`],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["Stripe", "Razorpay", "Shopify", "Courier APIs", `${brand.productPrefix} Stock`, "Google Analytics"],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["Email", "WhatsApp", "Slack & Teams", "Jira", "Twilio", `${brand.productPrefix} ID`],
    faqs: [
      ...
      { q: "Is it ITIL-aligned?", a: `${brand.productPrefix} ITSM covers incident, problem, change and release with a CMDB and CAB approvals. ${brand.productPrefix} Desk is the lighter customer-facing desk.` },
    ],
  },
  {
    ...
    integrations: ["Mailgun & SES", "Twilio", "WhatsApp Business", "Google Analytics", "Meta Ads", `${brand.productPrefix} CRM`],
    faqs: [
      ...
      { q: "How is attribution calculated?", a: `First-touch, last-touch and linear models side by side, joined to closed revenue from ${brand.productPrefix} CRM rather than to form fills.` },
  ...
  },
  {
    ...
    integrations: ["Booking.com", "Expedia", "Airbnb", "Payment gateways", "Door lock systems", `${brand.productPrefix} Books`],
    faqs: [
      ...
      { q: "Does it manage leases as well as stays?", a: `${brand.productPrefix} Estate covers long-term leases, escalations and rent roll; ${brand.productPrefix} Stay covers nightly reservations. They share the same unit inventory.` },
    ],
  },
  {
    ...
    integrations: ["Active Directory & Entra ID", "Okta", "SAML & OIDC apps", "SCIM", "Splunk & SIEM", `${brand.productPrefix} ITSM`],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["Microsoft 365", "Google Drive", "DocuSign", `${brand.productPrefix} ERP`, "Email", "Scanners"],
    faqs: [
