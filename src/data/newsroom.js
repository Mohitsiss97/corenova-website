...
export const pressReleases = [
  {
    ...
    date: '2026-08-19',
    tag: 'Product',
    title: 'CoreNova ships Nova Flow 2.0, bringing no-code approvals to every product',
    body: 'The release makes the workflow designer available across the full Nova range, so an approval chain defined once applies to purchase orders, leave requests and document sign-off without separate configuration in each product.',
  },
  {
    slug: 'dotnet-10-migration-practice',
    date: '2026-06-03',
    tag: 'Company',
    title: 'CoreNova formalises its .NET modernisation practice as .NET 10 LTS lands',
  ...
  },
  {
    ...
    date: '2026-02-11',
    tag: 'Compliance',
    title: 'CoreNova recertifies to ISO 27001:2022 and completes its fourth SOC 2 Type II',
  ...
  },
  {
    ...
    date: '2025-11-06',
    tag: 'Company',
    title: 'CoreNova opens a Middle East office in Dubai',
    body: 'The office serves GCC customers with local implementation and support cover, following three years of delivering into the region from Noida.',
  },
  {
    ...
    body: 'Nova Care HIS replaced paper records and three legacy systems across a 1,400-bed group, migrating 1.2 million patient records over eleven months.',
  },
];
...
export const brandAssets = [
  ...
  { name: 'Product screenshots', detail: 'High-resolution captures of the Nova console', size: 'ZIP · 12 MB' },
  { name: 'Leadership headshots', detail: 'Print-resolution portraits with credits', size: 'ZIP · 8 MB' },
];

export const pressContact = {
  name: 'Press office',
  email: 'press@corenova.tech',
